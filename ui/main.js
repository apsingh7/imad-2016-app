...
function loadLoginForm () {
    var loginHtml = `
        ...
        <br/><br/><div class="bb">
        <input type="submit" id="login_btn" value="Login"  style="width:100px; height:50px; background-color:red;"/>
        <input type="submit" id="register_btn" value="Register"    style="width:100px; height:50px; background-color:red;"/>
        </div>
        <script>
