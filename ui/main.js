...
function loadLoginForm () {
    var loginHtml = `
        ...
        <br/><br/><div class="bb">
        <input type="submit" id="login_btn" value="Login"  style="width:50px;height:50px;padding:10px;background-color:red;"/>
        <input type="submit" id="register_btn" value="Register"    style="width:50px;height:30px;padding:10px;background-color:red;"/>
        </div>
        <script>
